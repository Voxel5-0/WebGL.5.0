...
function fw_initialize() {
    ...
    gl.bindAttribLocation(fw_shaderProgramObject, WebGLMacros.AMC_ATTRIBUTE_VERTEX, "aVertexPosition");
    gl.bindAttribLocation(fw_shaderProgramObject, WebGLMacros.AMC_ATTRIBUTE_COLOR, "aVertexColor");
    gl.bindAttribLocation(fw_shaderProgramObject, WebGLMacros.AMC_ATTRIBUTE_SIZE, "aVertexSize");
    ...
    gl.enableVertexAttribArray(WebGLMacros.AMC_ATTRIBUTE_SIZE);
...
function fw_display(t) {
    ...
    // mat4.translate(mMatrix, mMatrix, [0.0, 0.0, -50.0]);
    mat4.translate(t, t, [0.0, 0.0, -2.0]);
    // mat4.scale(mMatrix, mMatrix, [50.0, 50.0, 50.0]);
