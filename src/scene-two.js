...
//87.06538690162104,76.27367474731827,220.2064288844317 , -8.227260474763973 , -93.46873192006223
//85.54966728431751,76.87253131406523,215.2747400203303 , -7.891943332010076 , -93.6055290907498
/*----------------------------------- Camera Contol Points and variables -----------------------------------*/
//Need to reset camera paths
// const Scene2_controlPoints = [
//   [85.54966728431751,76.87253131406523,215.2747400203303 , -7.891943332010076 , -93.6055290907498],
//   [10.62901167174151,95.65099812412927,280.2914614603873 , 2.364373357682116 , -97.99999999999952],
//   [55.21280150157958,72.81144436996345,465.55190974760137 , -14.635626642317867 , -94.59999999999941],
//   [185.6143804144843,75.37598001356025,335.49216348625794 , -14.635626642317867 , -94.59999999999941]
...
const Scene2_controlPoints = [
  [85.54966728431751,76.87253131406523,215.2747400203303 , -7.891943332010076 , -93.6055290907498],
  [35.62901167174151,95.65099812412927,280.2914614603873 , 2.364373357682116 , -97.99999999999952],
  [75.21280150157958,68.81144436996345,350.55190974760137 , 0.635626642317867 , -130.59999999999941],
  [200.6143804144843,70.37598001356025,335.49216348625794 , 0.635626642317867 , -90.59999999999941]
  // [144.3809611232921,79.18538151916013,343.3457449067854 , -7.461111947191337 , -87.19999999999942],
  // [948.199097797844,212.81782870451985,291.73360447533565 , -18.261111947191317 , -90.99999999999946]
];
...
function UpdateSceneTwo()
{
  ...
  if(scene_two_StartTime + scene_two_duration - scene_tst_one < currentTime){
    scene++;
  }
  // if(scene_two_StartTime + scene_two_duration - scene_tst_one < currentTime){
  //   fadeOut();
