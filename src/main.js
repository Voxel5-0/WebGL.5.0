...
var modelList = [
	{ name: "Castle",	 	files:[ 'src\\resources\\models\\intro\\CastleWithMaterials.gltf', 'src\\resources\\models\\intro\\CastleWithMaterials.bin'],								flipTex:false,	isStatic : true , isInstanced :false, instanceCount : 1},
	{ name: "CastleReflection",	 	files:[ 'src\\resources\\models\\intro\\JustCastle.gltf', 'src\\resources\\models\\intro\\JustCastle.bin'],											flipTex:false,	isStatic : true , isInstanced :false, instanceCount : 1},
	...
	{ name: "Bridge", 		files:[ 'src\\resources\\models\\scene4\\bridge\\bridge_1.gltf', 'src\\resources\\models\\scene4\\bridge\\bridge_1.bin'], 									flipTex:true, 	isStatic : true , isInstanced :false, instanceCount : 1},
